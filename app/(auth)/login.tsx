...
export default function LoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    try {
      // Mock Login - Ganti dengan API real
      const mockToken = {
        accessToken: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiJ1c2VyLTEyMyIsImVtYWlsIjoidXNlckBleGFtcGxlLmNvbSIsImV4cCI6MTc0OTk5OTk5OX0.mock',
